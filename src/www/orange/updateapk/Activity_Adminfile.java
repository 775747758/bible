...
public class Activity_Adminfile extends Activity {
	...
	private void setupViews() {
		setContentView(R.layout.admin_file);
	...
	protected void downloadFile() {
		...
		mCloudStorage.downloadFile(mFile, new FileProgressListener() {
			...
			@Override
			public void onProgress(String source, long bytes, long total) {
				mInfoView.setText(source + " download......:" + bytes * 100 / total + "%");
			...
			public void onSuccess(String source, String newTargetName) {
				...
				mInfoView.setText(source + " downloaded as " + newTargetName + " in the local.\n提示：如果下载文件在本地有同名文件，则下载的文件会被按时间戳重命名哦~");
	...
	protected void deleteFile() {
		...
		mCloudStorage.deleteFile(mFile, new FileOperationListener() {
