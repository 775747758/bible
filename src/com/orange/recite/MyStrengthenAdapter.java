...
public class MyStrengthenAdapter extends BaseAdapter {
	...
	public MyStrengthenAdapter(Context context, List<Map<String, String>> itemMap) {
	...
	public View getView(int position, View convertView, ViewGroup parentView) {
		ViewHolder holder = null;
			...
			convertView = LinearLayout.inflate(context, R.layout.listitem_strengthen, null);
