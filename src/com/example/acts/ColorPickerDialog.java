...
public class ColorPickerDialog extends Dialog {
	...
	private class ColorPickerView extends View {
		...
		public ColorPickerView(Context context, int height, int width) {
			...
			// r = width / 2 - mPaint.getStrokeWidth();
			...
			centerRadius = (r - mPaint.getStrokeWidth() / 2 * 0.7f) - 50;
			...
			rectTop = r + mPaint.getStrokeWidth() * 0.5f + mLinePaint.getStrokeMiter() * 0.5f + 45;
